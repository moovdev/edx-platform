...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'staging@moov.life')  # django default is ''
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', 'pbrugfycvncbmseb')  # django default is ''
